...
class ProductionCO2ModelClass():
    ...
    def households(self,p1,p2):
        ...
        def value_of_choice(l):
            ...
            U = u_c - u_l # following the PS
            return -U

        # b. find optimal labor supply

        # ADD CODE HERE - any method will do
        # however bounded with lower bound 0 is needed as we have no other restriction on labor supply
    ...
    def solve(self,do_print=False):
        ...
        def obj(logp):
            ...
            errors = self.market_clearing(p) # REPLACE CODE HERE - use errors from market_clearing
